...
function obtenerCarpeta(anio) {
  ...
  // 1. Primero obtenemos la carpeta raíz de la aplicación (ej. APP_HECT)
  const carpetaRaizApp = obtenerOCrearCarpetaRaiz();

  // 2. Buscamos la carpeta del año dentro de esa carpeta raíz
  ...
  return null; // Si no existe la carpeta del año, no hay nada que limpiar
}
